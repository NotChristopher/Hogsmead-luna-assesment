export const Questions = [{
    ...
    answers : [{answer : 'You immediately use it to go back and right a wrong, no matter the consequences to the timeline.' , trait : 'Courage'},
         {answer : 'You study it carefully, weighing the potential wisdom in using such a powerful object, before deciding whether to act.', trait : 'Intelligence' },
    ...
    answers : [{answer : 'You immediately take the wand, eager to test its power, regardless of the consequences' , trait : 'Courage'},
         {answer : 'You pause to study the wand`s history and understand its origins, seeking to learn its true potential before making a move.', trait : 'Intelligence' },
    ...
    answers : [{answer : 'You take charge, showing your bravery and confidence, ready to lead the partnership and face the mystery head-on.' , trait : 'Courage'},
         {answer : 'You are eager to learn from the Centaur`s wisdom, taking a backseat in the partnership to observe and absorb as much knowledge as possible', trait : 'Intelligence' },
    ...
    answers : [{answer : 'You boldly approach, confident that you can tame the Griffin or defeat it in a challenge.' , trait : 'Courage'},
         {answer : 'You study the Griffin carefully, trying to understand its behavior and figuring out how to gain its trust.', trait : 'Intelligence' },
    ...
    answers : [{answer : ' You choose a powerful artifact, knowing it could help you face any challenge or enemy in your path.' , trait : 'Courage'},
         {answer : 'You choose a book of magical recipes, excited to learn new spells and potions through creativity', trait : 'Intelligence' },
    ...
    answers : [{answer : 'Stand your ground, ready to face the Thestral head-on. You`re not afraid of any danger.', trait : 'Courage'},
         {answer : 'Observe the Thestral from a distance, trying to learn about it before taking any action', trait : 'Intelligence' },
    ...
    answers : [{answer : 'You dive straight into solving it, trusting your instincts and courage to guide you' , trait : 'Courage'},
         {answer : 'You take your time to think through each clue carefully, using your intelligence and wit to decipher the  Runestone', trait : 'Intelligence' },
    ...
    answers : [{answer : ' Excited and ready to show your strength and skills.' , trait : 'Courage'},
         {answer : 'Curious about how the duel works and eager to learn from the experience, even if it’s a bit dangerous', trait : 'Intelligence' },
    ...
    answers : [{answer : 'You accept without hesitation, excited to learn dark magic and prove your strength by mastering it' , trait : 'Courage'},
         {answer : 'You ask many questions about the spells, intrigued by the knowledge and eager to understand the full scope of the magical art. ', trait : 'Intelligence' },
